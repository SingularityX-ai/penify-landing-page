            ...
            <div className="col-12">
              <div className="error__content text-center">
                <div className="section__header">
                  ...
                  <p data-aos="fade-up" data-aos-duration="600" data-aos-delay="600" style={{color: "white", letterSpacing: "0px"}}>We couldn&apos;t find that page, please check the URL and try again.</p>
                </div>
